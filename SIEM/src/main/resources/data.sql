...
insert into alarm (id, name, description, seconds,number, prival, version, timestamp, hostname, appname , procid, msgid, sd, msg, can_delete) 
values (1001,'status50..', 'status 50..', 60, 3, 0, 0, '','!hostname!','Server','','','status=\"50', '', false); 
insert into alarm (id, name, description, seconds,number, prival, version, timestamp, hostname, appname , procid, msgid, sd, msg, can_delete) 
values (1002,'Login in application', 'Invalid login', 300, 5, 0, 0, '','!hostname!','Firewall','','','UserID', 'Invalid username or password', false); 
insert into alarm (id, name, description, seconds,number, prival, version, timestamp, hostname, appname , procid, msgid, sd, msg, can_delete) 
values (1003,'Registration in application', 'Invalid registration', 300, 5, 0, 0, '','!hostname!','Firewall','','','UserID', 'Username already exists', false);
insert into alarm (id, name, description, seconds,number, prival, version, timestamp, hostname, appname , procid, msgid, sd, msg, can_delete) 
values (1004,'Firewall error', 'Drop action in firewall', 60, 2, 0, 0, '','!hostname!','Firewall','','','', 'DROP', false);
insert into alarm (id, name, description, seconds,number, prival, version, timestamp, hostname, appname , procid, msgid, sd, msg, can_delete) 
values (1005,'Firewall lost', 'Info-events-losst action in firewall', 60, 1, 0, 0, '','!hostname!','Firewall','','','', 'INFO-EVENTS-LOST', false);
insert into alarm (id, name, description, seconds,number, prival, version, timestamp, hostname, appname , procid, msgid, sd, msg, can_delete) 
values (1006,'Message error', 'Message field is error', 60, 3, 0, 0, '','!hostname!','','','','', 'error', false);
insert into alarm (id, name, description, seconds,number, prival, version, timestamp, hostname, appname , procid, msgid, sd, msg, can_delete) 
values (1007,'Stuctured data error', 'Sd contains the word error', 60, 3, 0, 0, '','!hostname!','','','','error', '', false);
