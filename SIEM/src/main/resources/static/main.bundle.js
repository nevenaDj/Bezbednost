...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__logs_logs_component__ = __webpack_require__("../../../../../src/app/logs/logs.component.ts");
...
var routes = [
    ...
    {
        path: 'logs', component: __WEBPACK_IMPORTED_MODULE_3__logs_logs_component__["a" /* LogsComponent */]
    },
    { path: '**', redirectTo: '' }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__logs_logs_component__ = __webpack_require__("../../../../../src/app/logs/logs.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__logs_logs_service__ = __webpack_require__("../../../../../src/app/logs/logs.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__logs_logs_component__["a" /* LogsComponent */]
            ],
            imports: [
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_10__logs_logs_service__["a" /* LogsService */]
            ],
...
// module
exports.push([module.i, ".container-4 input#update{\n    height: 30px;\n    width: 10%;\n    float: right;\n    background: #f0f0f0;\n    border: none;\n    font-size: 15px;\n    color: rgba(76, 88, 111, 0.7);\n    padding-left: 15px;\n    border-radius: 5px;\n  }\n  \n  .container-4 input#update:focus{\n    background: #eaeaea;\n    width: 90%;\n    float: right;\n  }\n  ", ""]);
...
var LogsService = /** @class */ (function () {
    ...
    LogsService.prototype.getLogs = function (page, size) {
        ...
        var httpParams = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpParams */]().set('page', page.toString()).set('size', size.toString()).set('sort', 'id,desc');
        return this.http
